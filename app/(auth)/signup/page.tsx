    ...
    try {
      ...
      if (data.user) {
        ...
        if (!data.session) {
           ...
           router.push("/login"); // Don't try to auto-login if no session returned
           return;
        }
    ...
    <div className="min-h-screen bg-[#020617] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        <div className="flex flex-col items-center mb-8">
           ...
           <h2 className="text-2xl font-bold text-white text-center">Join 10,000+ Indian students</h2>
           <p className="text-muted-foreground mt-2 text-sm">Start your Master's journey with AI guidance.</p>
        </div>

        <Card className="bg-[#111827]/80 border-white/10 backdrop-blur-xl shadow-2xl relative">
          <CardHeader>
            <CardTitle className="text-xl font-bold font-outfit text-white">Create Account</CardTitle>
          </CardHeader>
          ...
          <CardContent className="space-y-5">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button disabled={isLoading} type="submit" className="w-full h-12 bg-primary text-background font-bold shadow-xl shadow-primary/20">
                {isLoading ? "Creating..." : "Sign Up"} <ArrowRight className="ml-2 w-5 h-5" />
              </Button>
            </form>
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-[10px] uppercase">
                <span className="bg-[#111827] px-2 text-muted-foreground font-mono">Or join with</span>
              </div>
            </div>
          ...
          <CardFooter className="flex flex-col space-y-4 pt-4 border-t border-white/5 bg-white/[0.01]">
            ...
            <p className="text-xs text-center text-muted-foreground border-t border-white/5 pt-4">
